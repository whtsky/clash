...
import (
	...
	"github.com/whtsky/clash/component/auth"
	"github.com/whtsky/clash/component/dialer"
...
func patchSelectGroup(proxies map[C.AdapterName]C.Proxy) {
